...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">Atlas sport</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 fs-4">
        ...
        <li class="nav-item">
          <a class="nav-link" href="seconnect.php">inscription</a>
        </li>
        <li class="nav-item">
        </li>
        <li class="nav-item">
      ...
      <form class="d-flex" method="GET">
       ...
       <!-- <button class="btn btn-outline-light" type="submit">Search</button>-->
          <input type="submit" value="search" name="search_data_produit" class="btn btn-outline-light">
      </form>
    </div>
  </div>
                      </nav>
    ...
    <!---2eme child >
                    -3eme child-->
                    <div class="bg-light  p-2 fs-4 my-1">
                        <h3 class="text-center">Atlas Shop</h3>
        ...
        <h1 class="text-center fs-1">contacter nous!</h1>
         ...
         <form action="contact.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4 ">
                ...
                <input type="text" class="form-control fs-5" placeholder="Name" name="name"  >
            </div>
            <!-- description -->
            <div class="form-outline mb-4 ">
                
                <input type="text"   class="form-control fs-5" placeholder="Email" name="email" >
            </div>
            <!-- keyword -->
            <div class="form-outline mb-4">
               
                <input type="number" class="form-control fs-5" placeholder="Number" name="number">
            </div>
            <div class="mb-3">
  
  <textarea class="form-control fs-5" id="exampleFormControlTextarea1" rows="3" placeholder="message" name="message"></textarea>
</div>
<div class="form-outline mb-4 w-50 m-auto">
                <input type="submit" name="message" class="btn btn-info mb-3 px-5 p-3 fs-4" value="envoyer message">
                </div>
          </div>
